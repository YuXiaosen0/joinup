...
<<<<<<< HEAD
  const hosts = "169.254.231.3,192.168.56.1,192.168.160.1,192.168.87.1,10.193.72.16,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_FatZ5S";
=======
  const hosts = "10.192.234.85,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_PYrWVq";
...
var define_process_env_UNI_STAT_TITLE_JSON_default = {};
...
const get_platform_name = () => {
  ...
  return platformList["mp-weixin"] || "mp-weixin";
};
const get_pack_name = () => {
  let packName = "";
